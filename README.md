...
　&ensp; 1．投稿一覧：フォロしているユーザーの投稿を見ることができる。<br>
　&ensp; 2．検索    ：フォロしているユーザーの投稿を見ることができる。<br>
　&ensp;&ensp; 2-1．投稿一覧　　　全ユーザの投稿を見ることができる。タグ検索が可能。<br>
　&ensp;&ensp; 2-2．ユーザー一覧　利用ユーザーを検索することができる。<br>
　&ensp;&ensp; 2-3．イベント一覧　イベント登録時に「公開する」としたイベント情報一覧を見ることができる。<br>イベント名で検索することができる。
　&ensp; 3．投稿    ：参加したイベントの思い出等を投稿することができる。<br>
